...
class LocationsStorage {
    ...
    init() {
        ...
        let locationFilesURLs = try? fileManager.contentsOfDirectory(at: documentsURL ?? URL(fileURLWithPath: ""),
    ...
    func saveLocationOnDisk(_ location: Location) {
        ...
        let fileURL = (documentsURL ?? URL(fileURLWithPath: "")).appendingPathComponent("\(timestamp)")
